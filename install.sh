...
printf "\n\e[1;35;47m  _     _                 _          \e[0m"
printf "\n\e[1;35;47m | |   (_)_ __ ___   ___ | | ____ _  \e[0m"
printf "\n\e[1;35;47m | |   | | '_ ` _ \ / _ \| |/ / _` | \e[0m"
printf "\n\e[1;35;47m | |___| | | | | | | (_) |   < (_| | \e[0m"
printf "\n\e[1;35;47m |_____|_|_| |_| |_|\___/|_|\_\__,_| \e[0m"
...
if echo "$OSTYPE" | grep -qE '^linux-gnu.*' && [ -f '/etc/debian_version' ]; then
	...
	printf "\r\033[1;31mUnrecognised OS.\e[0m Please follow 'Manual installation' at \033[0;94mhttps://github.com/amm1edev/Limoka/#-installation\e[0m"
	exit 1
fi
...
# shellcheck disable=SC2086
runout ${SUDO_CMD}git clone https://github.com/amm1edev/Limoka/ || {
